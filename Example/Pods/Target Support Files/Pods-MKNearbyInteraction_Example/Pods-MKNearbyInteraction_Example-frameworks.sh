...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/MKNearbyInteraction/MKNearbyInteraction.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/SYNoticeBrowseLabel/SYNoticeBrowseLabel.framework"
