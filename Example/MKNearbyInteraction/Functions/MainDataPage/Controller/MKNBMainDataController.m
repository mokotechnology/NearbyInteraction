...
@interface MKNBMainDataController ()<NISessionDelegate,
ARSessionDelegate,
mk_nb_accessorySharedDataDelegate>

@property (nonatomic, strong) CAGradientLayer *gradientLayer;

@property (nonatomic, strong)MKNBMainDataView *dataView;
...
@implementation MKNBMainDataController
...
- (void)viewDidLoad {
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self 
                                             selector:@selector(deviceConnectStatusChanged)
                                                 name:mk_nb_peripheralConnectStateChangedNotification 
                                               object:nil];
}
...
- (void)deviceConnectStatusChanged {
    if ([MKNBCentralManager shared].connectStatus != mk_nb_centralConnectStatusConnected) {
...
- (MKNBMainDataView *)dataView {
    if (!_dataView) {
        _dataView = [[MKNBMainDataView alloc] init];
