...
@interface MKCJDegreeLabel : UIView
...
@implementation MKCJDegreeLabel
...
@interface MKCJMainDataView ()

@property (nonatomic, strong)UILabel *titleLabel;

@property (nonatomic, strong)UIView *degreeView;

@property (nonatomic, strong)MKCJDegreeLabel *azimuthLabel;

@property (nonatomic, strong)MKCJDegreeLabel *elevationLabel;

@property (nonatomic, strong)UILabel *distanceLabel;

@property (nonatomic, strong)UILabel *distanceValueLabel;

@property (nonatomic, strong)MKCJCirclePatternView *circleView;

@property (nonatomic, strong)MKCJArrowView *arrowView;

@property (nonatomic, strong)MKCJErrorView *errorView;
...
@implementation MKCJMainDataView
...
- (void)layoutSubviews {
    ...
    [self.titleLabel mas_remakeConstraints:^(MASConstraintMaker *make) {
        ...
        make.height.mas_equalTo(MKFont(25.f).lineHeight);
    }];
    ...
    [self.distanceValueLabel mas_remakeConstraints:^(MASConstraintMaker *make) {
        ...
        make.height.mas_equalTo(MKFont(40.f).lineHeight);
    }];
    [self.distanceLabel mas_remakeConstraints:^(MASConstraintMaker *make) {
        ...
        make.height.mas_equalTo(MKFont(50.f).lineHeight);
    }];
...
- (MKCJDegreeLabel *)azimuthLabel {
    if (!_azimuthLabel) {
        _azimuthLabel = [[MKCJDegreeLabel alloc] init];
        _azimuthLabel.msgLabel.text = @"azimuth";
        _azimuthLabel.icon.image = LOADICON(@"MKNearbyInteraction", @"MKCJMainDataView", @"cj_azimuth_icon.png");
        _azimuthLabel.valueLabel.text = @"-";
    }
    return _azimuthLabel;
}

- (MKCJDegreeLabel *)elevationLabel {
    if (!_elevationLabel) {
        _elevationLabel = [[MKCJDegreeLabel alloc] init];
        _elevationLabel.msgLabel.text = @"elevation";
        _elevationLabel.icon.image = LOADICON(@"MKNearbyInteraction", @"MKCJMainDataView", @"cj_elevation_icon.png");
        _elevationLabel.valueLabel.text = @"-";
    }
    return _elevationLabel;
}

- (MKCJCirclePatternView *)circleView {
    if (!_circleView) {
        _circleView = [[MKCJCirclePatternView alloc] initWithFrame:CGRectMake(0, 0, kViewWidth, kViewWidth)];
        _circleView.hidden = YES;
    }
    return _circleView;
}

- (MKCJArrowView *)arrowView {
    if (!_arrowView) {
        _arrowView = [[MKCJArrowView alloc] initWithFrame:CGRectMake(0, 0, kViewWidth, kViewWidth)];
...
- (UILabel *)errorLabel {
    if (!_errorLabel) {
        ...
        _errorLabel.font = MKFont(20.f);
        _errorLabel.numberOfLines = 0;
    }
    return _errorLabel;
}

- (MKCJErrorView *)errorView {
    if (!_errorView) {
        _errorView = [[MKCJErrorView alloc] initWithFrame:CGRectMake(0, 0, kViewWidth, kViewWidth)];
        _errorView.snowImage  = LOADICON(@"MKNearbyInteraction", @"MKCJMainDataView", @"cj_snow_white_icon.png");
        ...
        UIImage *image = LOADICON(@"MKNearbyInteraction", @"MKCJMainDataView", @"cj_snow_black_icon.png");
        if (image) {
...
- (UILabel *)distanceValueLabel {
    if (!_distanceValueLabel) {
        ...
        _distanceValueLabel.font = MKFont(40.f);
    }
...
- (UILabel *)distanceLabel {
    if (!_distanceLabel) {
        ...
        _distanceLabel.font = MKFont(50.f);
    }
...
- (UIButton *)closeButton {
    if (!_closeButton) {
        ...
        [_closeButton setImage:LOADICON(@"MKNearbyInteraction", @"MKCJMainDataView", @"cj_closeIcon.png") forState:UIControlStateNormal];
