...
@interface MKCJAboutController ()<UITableViewDelegate, UITableViewDataSource>
...
@implementation MKCJAboutController

- (void)dealloc {
    NSLog(@"MKCJAboutController销毁");
}
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath {
    MKCJAboutCellModel *model = self.dataList[indexPath.row];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    MKCJAboutCell *cell = [MKCJAboutCell initCellWithTableView:tableView];
...
- (void)loadTableDatas {
    MKCJAboutCellModel *faxModel = [[MKCJAboutCellModel alloc] init];
    faxModel.iconName = @"cj_faxIcon.png";
    faxModel.typeMessage = @"Fax";
    faxModel.value = @"86-75523573370-808";
    [self.dataList addObject:faxModel];
    
    MKCJAboutCellModel *telModel = [[MKCJAboutCellModel alloc] init];
    telModel.iconName = @"cj_telIcon.png";
    telModel.typeMessage = @"Tel";
    telModel.value = @"86-75523573370";
    [self.dataList addObject:telModel];
    
    MKCJAboutCellModel *addModel = [[MKCJAboutCellModel alloc] init];
    addModel.iconName = @"cj_addUsIcon.png";
    ...
    MKCJAboutCellModel *linkModel = [[MKCJAboutCellModel alloc] init];
    linkModel.iconName = @"cj_shouceIcon.png";
...
- (UIImageView *)aboutIcon{
    if (!_aboutIcon) {
        ...
        _aboutIcon.image = LOADICON(@"MKNearbyInteraction", @"MKCJAboutController", @"cj_aboutIcon.png");
    }
    return _aboutIcon;
}
